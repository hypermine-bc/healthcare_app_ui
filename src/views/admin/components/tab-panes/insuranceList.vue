        ...
        <el-row class="createPost-main-container">
          <el-col :span="12">
            <div v-if="dialogFormVisible" >
              ...
              <el-form-item label="Patient Money">
                <el-input v-model="formData.pmoney" placeholder="Enter amount for patient"/>
              </el-form-item>
            </div>
          </el-col>
          <el-col :span="12">
...
import { iqviaSignatureData } from '../../core/form-data'
...
export default {
    ...
    caseList() {
      ...
      this.list.forEach(element => {
        ...
        try {
          ...
          const patientIdBuff = element.patNoti.split('#')
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      fetchAsset(this.listQuery, 'IQVIADoctorNotification').then(response => {
    ...
    signPrescription() {
      ...
      createAsset(iqviaSignatureData, 'SignIqviaPrescription').then((e) => {
